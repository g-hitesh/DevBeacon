...
export default function Navbar() {
    ...
    return (
        <header className=' sticky top-0 pt-5' >
            <nav className="w-[80vw] mx-auto z-50  transition-all duration-300 opacity-[0.9] bg-[#fdfdfd]  backdrop-blur-sm border rounded-full">
                    ...
                    <div className="flex justify-between h-16">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:ml-6 md:flex md:space-x-4">
                                <Link href="/feed" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600  ">
                                    My Feed
                                </Link>
                                <Link href="/explore" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600  ">
                                    Explore
                                </Link>
                                <Link href="/bookmarks" className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600  ">
                                    Bookmarks
                                </Link>
                            </div>
                        </div>
